...
const About = () => {
  ...
  const { containerRef: valuesRef, visibleItems: valuesVisible } = useStaggeredAnimation(3, 150);
  ...
  return (
    <main className="pt-20 md:pt-24">
      ...
      {/* Values */}
      <section className="section-padding bg-card">
        <div ref={valuesRef} className="container-narrow">
          <div className="grid sm:grid-cols-3 gap-8 text-center">
            <div
              className={`space-y-3 transition-all duration-700 ${
                valuesVisible[0] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
            >
            ...
            <div
              className={`space-y-3 transition-all duration-700 ${
                valuesVisible[1] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
            >
            ...
            <div
              className={`space-y-3 transition-all duration-700 ${
                valuesVisible[2] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
            >
